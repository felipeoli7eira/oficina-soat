...
namespace App\Modules\OrdemDeServicoServico\Controller;

use App\Http\Controllers\Controller as BaseController;

use App\Modules\OrdemDeServicoServico\Requests\AtualizacaoRequest;
...
use App\Modules\OrdemDeServicoServico\Service\Service as OSService;
...
class Controller extends BaseController
{
     ...
     *      @OA\Response(
     *         response=200,
     *         description="Para quando a requisição for bem-sucedida. Pode ou não retornar serviços de ordem de serviço.",
     *         @OA\JsonContent(
     *             type="object",
     ...
     *                     @OA\Property(property="servico_uuid", type="string", format="uuid", example="3d17aa66-d72f-4861-9ef6-5bcbc5d2b5ba"),
     *                     @OA\Property(property="os_uuid", type="string", format="uuid", example="17dcbf4f-5c3b-4b69-8d6b-76b592cb47d5"),
     *                     @OA\Property(property="observacao", type="string", example="Serviço adicional"),
     ...
     *                 )
     *             ),
     *             @OA\Property(property="first_page_url", type="string", example="http://localhost:8080/api/os-servico?page=1"),
     *             @OA\Property(property="from", type="integer", example=1),
     *             @OA\Property(property="last_page", type="integer", example=1),
     *             @OA\Property(property="last_page_url", type="string", example="http://localhost:8080/api/os-servico?page=1"),
     *             @OA\Property(
     *                 property="links",
     *                 type="array",
     *                 @OA\Items(
     ...
     *             @OA\Property(property="path", type="string", example="http://localhost:8080/api/os-servico"),
     ...
     *          required=true,
     *          @OA\JsonContent(
     *              required={"servico_uuid", "os_uuid", "observacao", "quantidade", "valor"},
     *              @OA\Property(property="servico_uuid", type="string", format="uuid", example="3d17aa66-d72f-4861-9ef6-5bcbc5d2b5ba"),
     *              @OA\Property(property="os_uuid", type="string", format="uuid", example="17dcbf4f-5c3b-4b69-8d6b-76b592cb47d5"),
     *              @OA\Property(property="observacao", type="string", example="Serviço adicional para a ordem"),
     *              @OA\Property(property="quantidade", type="integer", example=2),
     *              @OA\Property(property="valor", type="number", format="float", example=150.50)
     *          )
     *      ),
     *      @OA\Response(
     *          response=201,
     *          description="Para quando a requisição for bem-sucedida. Retorna o cadastro do serviço de ordem de serviço.",
     *          @OA\JsonContent(
     ...
     *                  @OA\Property(property="nome", type="string", example="Troca de óleo"),
     ...
     *                  property="data",
     *                  type="array",
     *                  @OA\Items(type="string", example="O campo servico_uuid é obrigatório.")
     *              )
     *          )
     *      ),
     *      @OA\Response(
     ...
     *         in="path",
     *         required=true,
     *         description="UUID do serviço de ordem de serviço que deseja consultar",
     *         @OA\Schema(type="string", format="uuid")
     *     ),
     *     @OA\Response(
     *         response=200,
     *         description="Serviço de ordem de serviço encontrado com sucesso.",
     *         @OA\JsonContent(
     ...
     *     @OA\Response(
     *         response=404,
     *         description="Serviço de ordem de serviço não encontrado",
     *         @OA\JsonContent(
     ...
     *         name="uuid",
     *         in="path",
     *         description="UUID do serviço de ordem de serviço a ser removido",
     *         required=true,
     *         @OA\Schema(type="string", format="uuid")
     *     ),
     *     @OA\Response(
     *         response=204,
     *         description="Serviço de ordem de serviço removido com sucesso"
     *     ),
     *     @OA\Response(
     *         response=404,
     *         description="Serviço de ordem de serviço não encontrado",
     ...
     *         name="uuid",
     *         in="path",
     *         description="UUID do serviço de ordem de serviço a ser atualizado",
     *         required=true,
     *         @OA\Schema(type="string", format="uuid")
     *     ),
     *     @OA\RequestBody(
     ...
     *     @OA\Response(
     *         response=200,
     *         description="Serviço de ordem de serviço atualizado com sucesso",
     *         @OA\JsonContent(
     ...
     *             @OA\Property(property="quantidade", type="integer", example=3),
     *             @OA\Property(property="valor", type="number", format="float", example=200.75),
     *             @OA\Property(property="servico", type="object",
     *                 @OA\Property(property="id", type="integer", example=2),
     *                 @OA\Property(property="uuid", type="string", example="3d17aa66-d72f-4861-9ef6-5bcbc5d2b5ba"),
     *                 @OA\Property(property="nome", type="string", example="Alinhamento"),
     *                 @OA\Property(property="preco", type="number", format="float", example=65.90)
     *             ),
     *             @OA\Property(property="ordemDeServico", type="object",
     *                 @OA\Property(property="id", type="integer", example=1),
     *                 @OA\Property(property="uuid", type="string", example="17dcbf4f-5c3b-4b69-8d6b-76b592cb47d5"),
     *                 @OA\Property(property="descricao", type="string", example="Serviço completo"),
     ...
     *         description="Serviço de ordem de serviço não encontrado",
     *         @OA\JsonContent(
     *             @OA\Property(property="message", type="string", example="Serviço de ordem de serviço não encontrado"),
     *             @OA\Property(
     *                 property="errors",
     *                 type="array",
     *                 @OA\Items(type="string", example="O campo uuid selecionado é inválido.")
