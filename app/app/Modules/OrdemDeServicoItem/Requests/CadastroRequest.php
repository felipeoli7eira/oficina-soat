...
namespace App\Modules\OrdemDeServicoItem\Requests;
...
class CadastroRequest extends FormRequest
{
    ...
    {
        return [
            'peca_insumo_uuid' => ['required', 'uuid', 'exists:peca_insumo,uuid'],
    ...
    {
        return [
            'peca_insumo_uuid.required' => 'O campo peça/insumo é obrigatório.',
            'peca_insumo_uuid.exists'   => 'A peça/insumo informada não existe.',
    ...
    public function toDto(): CadastroDto
    {
        ...
        return new CadastroDto(
            peca_insumo_uuid: $validated['peca_insumo_uuid'],
