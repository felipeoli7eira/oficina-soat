...
class OrdemDeServicoServicoAtualizacaoTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_ordem_de_servico_servico_pode_ser_atualizada(): void
    {
        // Arrange
        ...
        // Act - Atualizar o serviço
        $updateResponse = $this->withAuth()->putJson('/api/os-servico/' . $response->json('uuid'), [
            'observacao' => 'Serviço atualizado conforme nova solicitação',
        ]);
    ...
    public function test_quantidade_do_servico_pode_ser_atualizada(): void
    {
        // Arrange
        $os = OrdemDeServico::factory()->create()->fresh();
        $servico = Servico::factory()->create()->fresh();
    ...
    public function test_valor_do_servico_pode_ser_atualizado(): void
    {
        // Arrange
        $os = OrdemDeServico::factory()->create()->fresh();
        $servico = Servico::factory()->create()->fresh();
    ...
    public function test_atualizacao_os_servico_nao_encontrado_lanca_model_not_found_exception(): void
    {
        $uuidFake = 'uuid-inexistente-1234';

        $mockDto = Mockery::mock(\App\Modules\OrdemDeServicoServico\Dto\AtualizacaoDto::class);
    ...
    public function test_atualizacao_os_servico_retorna_erro_de_regra_de_negocio(): void
    {
    ...
    public function test_atualizacao_os_servico_retorna_erro_interno_em_excecao_generica(): void
    {
        $uuidFake = 'uuid-valido-1234';
